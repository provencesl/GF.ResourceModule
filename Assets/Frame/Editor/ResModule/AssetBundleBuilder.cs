...
public static class AssetBundleBuilder 
{
    ...
    /// 配置路径
    /// </summary>
    //private static string _configPath = EditorStr.ASSETBUNDLE_SETTING_PATH;
    private static string _configPath = EditorStr.ASSETBUNDLE_SETTING_PATH;
    ...
    /// 构建AB包
    /// </summary>
    [MenuItem(EditorStr.BUILD_ASSETBUNDLE)]
    ...
    /// 设置AB包
    /// </summary>
    [MenuItem(EditorStr.SETTING_ASSETBUNDLE)]
    ...
    private static AssetBundleSetting GetDefaultConfig()
    {
        ...
        {
            outputDir = EditorStr.ASSETBUNDLE_DEFAULT_OUTPUTDIR_STREAMINGASSETS,
